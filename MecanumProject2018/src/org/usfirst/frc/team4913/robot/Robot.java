...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		// CameraServer.getInstanFce().startAutomaticCapture();
		// m_oi = new OI();
	...
	public void autonomousInit() {
		 ...
		 * straight
		 * 
		 * 2. Middle position: if (deliverCube) turn left/right and deliver cube else
		 * delay? turn left OR right and breach line
		 * 
		 * | |1 -----------| | |---| | |->---->| S | | | | W | |2 -| | I | | | | T | | |
		 * | C | | |->---->| H | | |---| |3 -----------^ |
		 * 
		...
		// m_autonomousCommand = new AutonomousOutsideDrive(TURN.RIGHT, true,
		// useVision);
		// } else
		// m_autonomousCommand = new AutonomousOutsideDrive(TURN.RIGHT, false,
		// useVision);
		// break;
		...
		// else
		// m_autonomousCommand = new AutonomousMiddleDrive(TURN.STRAIGHT, false,
		// useVision);
		// break;
		...
		// m_autonomousCommand = new AutonomousOutsideDrive(TURN.LEFT, false,
		// useVision);
		// break;
		// }
