...
public class RobotMap {
	...
	// Drive motor ports for mecanum drive uses PWM ports
	public static int LEFT_REAR_MOTOR_PORT = 6;
	public static int LEFT_FRONT_MOTOR_PORT = 7;
	public static int RIGHT_REAR_MOTOR_PORT = 8;
	public static int RIGHT_FRONT_MOTOR_PORT = 9;
